  ...
  useEffect(() => {
    async function getData() {
      var response = await fetch(
        "https://newsapi.org/v2/everything?q=technology&language=en&pagesize=4&sortBy=publishedAt&apiKey=14621d806ef243c2a772655987f6ca71"
      );
        ...
        <div className="container py-lg-4 py-md-3">
          <div className="most-recent">
            <div className="title-align mb-4">
              <h3 className="title-left">Technology News</h3>
              <Link to="/techNews" className="more-posts">
                {" "}
